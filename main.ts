...
sprites.onOverlap(SpriteKind.Player, SpriteKind.tp_sala_jefe, function on_on_overlap(sprite: Sprite, otherSprite2: Sprite) {
...
//  Empujoncito final
sprites.onOverlap(SpriteKind.Player, SpriteKind.npc, function on_on_overlap2(sprite_player: Sprite, otherSprite: Sprite) {
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.normal_bullet, function on_on_overlap3(sprite_proj: Sprite, otherSprite4: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.tp_sala_lobby, function on_on_overlap4(sprite2: Sprite, otherSprite3: Sprite) {
    mySprite.setPosition(2573, 2782)
})
...
namespace SpriteKind22 {
    ...
    export const arma_hud2 = sprites.create(assets.image`
        gun
        `, SpriteKind.Food)
    SpriteKind22.arma_hud2.setFlag(SpriteFlag.RelativeToCamera, true)
    SpriteKind22.arma_hud2.setPosition(20, 105)
    //  Variable para saber qué arma tenemos equipada
    export const arma_actual2 = "pistola"
}
