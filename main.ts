...
sprites.onOverlap(SpriteKind.Player, SpriteKind.tp_sala_jefe, function on_on_overlap2(sprite: Sprite, otherSprite2: Sprite) {
...
//  Empujoncito final
sprites.onOverlap(SpriteKind.Player, SpriteKind.npc, function on_on_overlap3(sprite_player2: Sprite, otherSprite: Sprite) {
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.normal_bullet, function on_on_overlap4(sprite_proj2: Sprite, otherSprite4: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.tp_sala_lobby, function on_on_overlap5(sprite2: Sprite, otherSprite3: Sprite) {
    mySprite.setPosition(2573, 2782)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.bullet_poryectile, function on_on_overlap6(sprite_proj22: Sprite, otherSprite42: Sprite) {
